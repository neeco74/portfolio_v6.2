    ...
    <div class="">
        ...
        <div class="">
            ...
            <p class="padding-20-nl">
                <a href="<?php echo base_url(); ?>/admin/cat-blog/" class="btn btn-transition btn-success">Revenir à la liste des catégories de blog</a>
                ...
                <div class="col-md-8">
                    ...
                    <div class="form-group padding-10">
                        ...
                        <div class="col-md-8 input-form">
                            <input type="text" class="form-control" name="titre" id="titre" value="<?= isset($catBlog['titre']) ? $catBlog['titre'] : ''; ?>" required autofocus />
                        </div>
                    </div>
